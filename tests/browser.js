...
document.getElementById('run').onclick = async function () {
    ...
    try {
        ...
        await until(function () { return w.EmpireConfig.isActive() && importedCount() === 2; });
        ...
        await until(function () { return importedCount() === 2 && w.EmpireConfig.get().save_context; });
        ...
        await until(function () { return state().techTreesLoaded && state().document.getElementById('save-import-file'); });
        assert(importedCount() === 2, 'Research survives reload');
